...
/*
 Just informative
#define TX_POWER_0   -2 dBm EIRP                              
#define TX_POWER_1   -4 dBm EIRP                                
#define TX_POWER_2   -6 dBm EIRP                               
#define TX_POWER_3   -8 dBm EIRP                             
#define TX_POWER_4   -10 dBm EIRP                                
#define TX_POWER_5   -12 dBm EIRP 
#define TX_POWER_6   -14 dBm EIRP     
#define TX_POWER_7   -16 dBm EIRP (normally not supported)                          
*/
