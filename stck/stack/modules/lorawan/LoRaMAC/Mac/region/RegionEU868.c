...
void RegionEU868InitDefaults( InitType_t type )
{
    switch( type )
    {
        case INIT_TYPE_INIT:
        {
            ...
            Channels[0] = ( ChannelParams_t ) EU868_LC4;    // uncomment this line to use single channel
/*
            Channels[0] = ( ChannelParams_t ) EU868_LC1;  // uncomment this line to use multiple channels
            Channels[1] = ( ChannelParams_t ) EU868_LC2;    // uncomment this line to use multiple channels
            Channels[2] = ( ChannelParams_t ) EU868_LC3;    // uncomment this line to use multiple channels
            Channels[3] = ( ChannelParams_t ) EU868_LC4;    // uncomment this line to use multiple channels
            Channels[4] = ( ChannelParams_t ) EU868_LC5;    // uncomment this line to use multiple channels
            Channels[5] = ( ChannelParams_t ) EU868_LC6;    // uncomment this line to use multiple channels
            Channels[6] = ( ChannelParams_t ) EU868_LC7;    // uncomment this line to use multiple channels
            Channels[7] = ( ChannelParams_t ) EU868_LC8;    // uncomment this line to use multiple channels
*/

/*
            #define EU868_LC4  867.1 MHz
            #define EU868_LC5  867.3 MHz
            #define EU868_LC6  867.5 MHz
            #define EU868_LC7  867.7 MHz
            #define EU868_LC8  867.9 MHz
            #define EU868_LC1  868.1 MHz
            #define EU868_LC2  868.3 MHz
            #define EU868_LC3  868.5 MHz 

*/


            // Initialize the channels default mask
            ChannelsDefaultMask[0] = LC(4);     // uncomment this line to use only 1 channel
          //  ChannelsDefaultMask[0] = LC(1) + LC(2) + LC(3) + LC(4) + LC(5) + LC(6) + LC(7) + LC(8); // uncomment this line to use multiple channels
